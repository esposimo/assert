...
use Esposimo\Assertion\Types\IsFloatAssertion;
...
#[CoversClass(IsFloatAssertion::class)]
class IsFloatAssertionTest extends TestCase
{
    #[Test]
    public function check_float_representation_and_type(): void
    {
        $value = 10.5;
        $assert = new IsFloatAssertion($value);
