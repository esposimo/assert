...
/**
 * This class is an implementation of a simple assertion to verify if the first operand is less than the second operand.
 *
 ...
 *
 */
class LessThanAssertion extends AbstractAssert
{
    /**
